...
public class Video312_Accordion extends Application {
    ...
    public void start(Stage stage) {
        ...
        //*** Creando acordeon. Hasta aquí mismo código que para TitlePane
        Accordion miAccordion= new Accordion();
        miAccordion.getPanes().addAll(miTitledPane, miTitledPane2, miTitledPane3);
        
        //añadir acordeon a un HBox
        HBox miHBox = new HBox(15, miAccordion);
