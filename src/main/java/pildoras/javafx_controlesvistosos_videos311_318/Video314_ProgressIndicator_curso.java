 ...
 * @author Pedro
 */
public class Video314_ProgressIndicator_curso extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        ProgressIndicator miProgress = new ProgressIndicator();
        ...
        primaryStage.setTitle("ProgressIndicator ejemplo Pildoras");
